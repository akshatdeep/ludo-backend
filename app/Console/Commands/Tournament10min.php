...
class Tournament10min extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'cron10min:cron';
    ...
    {   
        ...
        $end_time = Carbon::createFromFormat('Y-m-d H:i:s', $start)->addMinutes(10);
        $tournament = Tournament::where('tournament_interval', 10)->update([
            'end_time'    => $end_time,
            'start_time'    => $end,
        ]);
        $tournament = Tournament::where('tournament_interval', 10)->get();
